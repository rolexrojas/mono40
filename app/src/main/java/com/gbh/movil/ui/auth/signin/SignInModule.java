...
class SignInModule {
  ...
  @Provides
  @ActivityScope
  SignInPresenter providePresenter(StringHelper stringHelper, LoadIndicator loadIndicator,
    SessionManager sessionManager) {
    return new SignInPresenter(stringHelper, loadIndicator, sessionManager);
  }
}
