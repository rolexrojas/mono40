...
public class PinConfirmationFragment extends Fragment {
   ...
   * TODO
   */
  @BindViews({ R.id.pin_pad_button_zero, R.id.pin_pad_button_one, R.id.pin_pad_button_two,
    R.id.pin_pad_button_three, R.id.pin_pad_button_four, R.id.pin_pad_button_five,
    R.id.pin_pad_button_six, R.id.pin_pad_button_seven, R.id.pin_pad_button_eight,
    R.id.pin_pad_button_nine })
  List<View> digitPinPadButtons;

  /**
   * TODO
   */
  @BindView(R.id.pin_pad_button_delete)
   ...
   *   TODO
   */
  @OnClick({ R.id.pin_pad_button_zero, R.id.pin_pad_button_one, R.id.pin_pad_button_two,
    R.id.pin_pad_button_three, R.id.pin_pad_button_four, R.id.pin_pad_button_five,
    R.id.pin_pad_button_six, R.id.pin_pad_button_seven, R.id.pin_pad_button_eight,
    R.id.pin_pad_button_nine })
   ...
   * TODO
   */
  @OnClick(R.id.pin_pad_button_delete)
