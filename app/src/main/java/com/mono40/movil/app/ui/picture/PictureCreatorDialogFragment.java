...
import com.mono40.movil.app.ui.permission.PermissionRequestResult;
...
public final class PictureCreatorDialogFragment extends DialogFragment {
    ...
    public void onResume() {
        ...
        this.chooseFromGalleryActionView = dialog.findViewById(R.id.relative_layout_choose_from_gallery);
        ...
        this.useTheCameraActionView = dialog.findViewById(R.id.relative_layout_use_the_camera);
        this.useTheCameraActionView.setOnClickListener(this::onUseTheCameraOptionClicked);

        dialog.findViewById(R.id.relative_layout_delete_profile_image).setOnClickListener(new View.OnClickListener() {
            @Override
