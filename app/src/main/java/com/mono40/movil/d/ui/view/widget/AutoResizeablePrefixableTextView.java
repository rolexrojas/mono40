  ...
  public AutoResizeablePrefixableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    try {
      ...
      maxTextSize = array.getDimensionPixelSize(
        R.styleable.DepAutoResizeablePrefixableTextView_maxTextSize, defaultMaxTextSize);
      minTextSize = array.getDimensionPixelSize(
        R.styleable.DepAutoResizeablePrefixableTextView_minTextSize, defaultMinTextSize);
    } finally {
      array.recycle();
    }
  }
