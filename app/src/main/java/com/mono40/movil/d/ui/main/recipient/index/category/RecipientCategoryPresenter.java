...
import static com.mono40.movil.d.ui.main.recipient.index.category.Action.Type.ADD_ACCOUNT;
...
import com.mono40.movil.paypal.PayPalAccountRecipient;
...
final class RecipientCategoryPresenter extends Presenter<RecipientCategoryScreen> {
    ...
    private final com.mono40.movil.d.data.StringHelper sh;
    ...
    RecipientCategoryPresenter(
            ...
            Category category,
            com.mono40.movil.d.data.StringHelper sh,
            NetworkService ns,
    ...
    final void start() {
        this.queryDisposable = this.screen.onQueryChanged()
                ...
                .subscribe((query) -> {
                    ...
                    if (!this.deleting &&
                            (this.category == TRANSFER || this.category == RECHARGE)) {
                        final String label;
