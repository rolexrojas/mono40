...
public class Product implements Comparable<Product>, Parcelable {
  ...
  public static Product create(com.mono40.movil.product.Product product) {
  ...
  public final com.mono40.movil.product.Product toProduct() {
    return com.mono40.movil.product.Product.builder()
      .bank(this.bank)
      .type(this.type.name())
      .number(this.number)
      .alias(this.alias)
