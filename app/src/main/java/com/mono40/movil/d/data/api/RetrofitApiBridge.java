...
import com.mono40.movil.d.domain.ProductCreator;
import com.mono40.movil.d.domain.ProductInfo;
...
final class RetrofitApiBridge implements DepApiBridge {
    ...
    @Override
    public Observable<ApiResult<Void>> activatePurchaseWithoutNfc(Product fundingProduct, String pin) {
        final PurchaseWithoutNfcRequestBody body = PurchaseWithoutNfcRequestBody.builder()
                .fundingProduct(fundingProduct)
                .pin(pin)
                .build();
        return apiService.activatePurchaseWithoutNfc(body)
                .flatMap(mapToApiResult(MAP_FUNC_VOID));
    }
