 ...
 */
public class CustomBarCodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                R.styleable.zxing_view_zxing_scanner_layout, com.mono40.movil.R.layout.view_custom_bar_code);
...
//        barcodeView.initializeAttributes(attrs)initializeAttributes(attrs);
    ...
    public void initializeFromIntent(Intent intent) {
        ...
        if (intent.hasExtra("TORCH_ENABLED")) {
            if (intent.getBooleanExtra("TORCH_ENABLED", false)) {
                this.setTorchOn();
            }
        }
