...
public final class TransactionSummaryDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        ...
        if (ObjectHelper.isNull(this.transactionSummary.message())) {
            ((TextView) dialog.findViewById(R.id.transactionIdTextView))
        ...
        final TextView recipientQuestionTextView = ((TextView) dialog.findViewById(R.id.recipientQuestionTextView));
        final TextInputLayout recipientAnswerTextInputLayout = (dialog.findViewById(R.id.recipientAnswerTextInputLayout));
        final EditText recipientAnswerEditText = dialog.findViewById(R.id.recipientAnswerEditText);
