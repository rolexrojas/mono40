 ...
 * collapsing on smaller screens.</p>
 * <p/>
 ...
 * navigation drawer should be used instead.</p>
 * <p/>
 ...
 * instead. ({@link DrawerLayout DrawerLayout} implements this pattern.)</p>
 * <p/>
 ...
 * overlap weight behaves as it does in a LinearLayout.</p>
 * <p/>
 ...
 * user may use to grab the slideable view and pull it back over into a closed state.</p>
 */
public class SlidingPaneLayout extends ViewGroup {
   ...
   *
   * @param color
   *   An ARGB-packed color getValueContent
   */
  ...
  /**
   * @return The ARGB-packed color getValueContent used to fade the sliding pane
   */
  @ColorInt
  ...
  /**
   * @return The ARGB-packed color getValueContent used to fade the fixed pane
   */
  @ColorInt
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    if (widthMode != MeasureSpec.EXACTLY) {
      if (isInEditMode()) {
        ...
        throw new IllegalStateException("Width must have an exact getValueContent or MATCH_PARENT");
      }
   ...
   *
   * @deprecated Renamed to {@link #setShadowResourceLeft(int)} to support LTR (left to right
   * language) and {@link #setShadowResourceRight(int)} to support RTL (right to left language)
   ...
   * @param checkV
   *   Whether the view v passed should itself be checked for scrollability (true), or just its
   *   children (false).
   * @param dx
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
      ...
      for (int i = 0; i < childCount; i++) {
        ...
        if (!filter(child) && (child.getVisibility() == View.VISIBLE)) {
          // Force importance to "yes" since we can't read the getValueContent.
