...
public class RecoverPasswordChooserFragment extends DialogFragment {
    ...
    public static RecoverPasswordChooserFragment create(
            String title,
            String message,
        ...
        final RecoverPasswordChooserFragment fragment = new RecoverPasswordChooserFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(context)
                ...
                .setView(R.layout.fragment_recover_password_chooser);
        if (Texts.checkIfNotEmpty(negativeButtonText)) {
