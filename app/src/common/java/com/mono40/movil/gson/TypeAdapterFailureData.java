 ...
 * @author hecvasro
 */
final class TypeAdapterFailureData extends TypeAdapter<FailureData> {

  static TypeAdapterFailureData create(Gson gson) {
    return new TypeAdapterFailureData(gson);
  }
  ...
  private TypeAdapterFailureData(Gson gson) {
