...
import com.tpago.movil.d.data.api.BillResponseBody;
 ...
 */
@Deprecated
final class TypeAdapterInitialDataDeprecated implements JsonDeserializer<InitialData> {
  ...
  public InitialData deserialize(
    ...
    final JsonObject queryJsonObject = jsonObject.get(PROPERTY_QUERY)
      .getAsJsonObject();
